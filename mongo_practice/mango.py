...
class Connection(object):
    ...
    def get_collection(self, name: str) -> pymongo.collection.Collection or Exception:
    ...
    def read(self, query: dict, collection_name: str) -> pymongo.cursor.Cursor or dict:
    ...
    def update(self, search_filter: dict, query: dict, collection_name: str) -> dict:
        """
...
def test_create():
    ...
    c = Connection()
    data = {"name": "test", "age": 1, "type": "test"}
...
def test_update():
    ...
    c = Connection()
    search_filter = {"name": "test", "age": 1, "type": "test"}
    new_data = {"name": "test", "age": 2, "type": "test"}
...
def test_delete():
    ...
    c = Connection()
    data = {"name": "test", "age": 2, "type": "test"}
